...
describe('Nib documentation site', () => {
  it('ships the docs shell, full navigation, and its stylesheet in static HTML', async () => {
    ...
    expect(home).toContain('The Nib loop')
    expect(home).toContain('index.html')
    expect(home).toContain('default output')
    expect(home).toContain('Start with a route')
    expect(home).toContain('Initialize a site')
    expect(home).toContain('npx @briansunter/nib init my-site')
    expect(home).toContain('my-site/')
    expect(home).toContain('layout.tsx')
    expect(home).toContain('content/posts/')
    expect(home).toContain('Write a route in TSX')
    expect(home).toContain('Add Markdown and layouts')
    expect(home).toContain('Build typed collections')
    expect(home).toContain('src/islands/counter.tsx')
    expect(home).toContain('Build static output')

...
Nib is a self-contained static-site framework for React, Markdown, and opt-in islands. Scaffold a project, put a page file in a route folder, add a React island only when a subtree needs browser interaction, and deploy the prerendered output.

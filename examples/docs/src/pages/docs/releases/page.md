...
The npm package is connected to this GitHub Actions trusted publisher:
...
The release workflow uses Bun for installation and validation, then npm with GitHub Actions OIDC for `npm publish --provenance`. It does not require a long-lived npm token.

...
layout: article
---
![ ](/site-assets/heap_1673042424667_0.jpg)
...
How much time does it take? The maximum number of swaps equals the height of a complete binary tree, which is $O(log(n))$.
...
The time for insert or delete for a regular array is $O(n)$ because we have to shift the elements.

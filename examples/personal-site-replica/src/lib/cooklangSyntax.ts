  ...
  repository: {
    ...
    comments: {
      patterns: [
        ...
        {
          // Keep capture numbering from the source grammar while making the
          // optional leading group explicitly unanchored for Shiki's JS engine.
          begin: '()((--)(?:\\s*((@)internal)(?=\\s|$))?)',
          beginCaptures: {
            '1': {
...
export default cooklangRegistration;

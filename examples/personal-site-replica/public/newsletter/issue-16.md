...
url: "https://briansunter.com/newsletter/issue-16"
---
...
![Cover image for Cooking for Hackers](/_astro/1713157492098_0.u-TbefAn_Z2syrms.webp)
...
![Planning my weekly recipes in Logseq](/_astro/1713158284017_0.BhMvk2Dt_1MkrJT.webp)

Planning my weekly recipes in Logseq
...
![Very short title and introduction to recipes](/_astro/1713161377131_0.CBM0zij8_2jW5u1.webp)

Very short title and introduction to recipes

Ingredients listed in the recipe list, allowing users to decide whether to make a dish without clicking on the recipe.

![Ingredients shown on recipe list](/_astro/1713161458559_0.B0y-7FPB_Z1lYdjx.webp)

Ingredients shown on recipe list

Ingredients and instructions at the top of the page.

![Simple ingredients, cookware, and instructions](/_astro/1713161535491_0.C1sW5mVX_Vz4xm.webp)

Simple ingredients, cookware, and instructions

Inline ingredient amounts in instructions to avoid the need to scroll back to the top of the recipe while cooking.

![Ingredients amounts are included with gray background in instructions ](/_astro/1713161554003_0.CCBirfnd_2jNxN0.webp)

Ingredients amounts are included with gray background in instructions
...
![Cooklang syntax highlighting with colored amounts, cookware, and times](/_astro/1713161554003_0.CCBirfnd_2jNxN0.webp)

Cooklang syntax highlighting with colored amounts, cookware, and times
...
![Copy cooklang recipe on any page](/_astro/1713162065176_0.DSFUSGh4_1ccE98.webp)

Copy cooklang recipe on any page
...
![Cooklang app recipe collection](/_astro/IMG_0039_1713162304852_0.BVy9fkoz_ZLO331.webp)

Cooklang app recipe collection

![Viewing a recipe in cooklang](/_astro/IMG_0040_1713162338379_0.bcqKYdwQ_Z1ei7iR.webp)

Viewing a recipe in cooklang

![Using cooklang while cooking](/_astro/IMG_0044_1713162510087_0.CvRhRV6Z_ZBMNgk.webp)

Using cooklang while cooking

![Combined shopping list of all recipes](/_astro/IMG_0042_1713162549395_0.BTlFSp21_ZMhdde.webp)

Combined shopping list of all recipes
...
[Older Year in Review - Hawaii, Health, and Projects ](/newsletter/issue-15)[Newer ConvoCards Launch Retro](/convocards-launch-retro)
...
- [Organizing Notes in 3D with AI Sep 26, 2023](/newsletter/issue-14)

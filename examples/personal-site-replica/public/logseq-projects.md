...
url: "https://briansunter.com/logseq-projects"
---
...
![Cover image for How to manage projects in Logseq](/_astro/beebob_checkmark_in_checkbox_app_eea7631b-472d-4e91-acba-590250d7106c_1672269960068_0.B0JE-e9W_ZH59sD.webp)
...
I use projects in Logseq to manage almost everything I work on. I make a project for any task that takes longer than a day. I have projects across a wide range of categories like fitness, programming, cooking, etc. For example, my newsletter is a project, and so is my current weightlifting routine.

In this guide, I’ll share some of my thinking around projects, what I track, and how I manage everything in Logseq. The concepts translate to other tools as well.
...
Other times, I’ll want to work on something more ambitious, usually taking between two weeks and three months to finish.
...
Logseq helps you create a prioritized “work feed” of all your active projects, so you can make sure none of them stall.

### High level values and initiatives

Before starting tasks and taking notes, I think it’s worth doing some thinking about what your high-level values and priorities are, and writing them down.

I try to attach each project to one of these high level goals.

I do a detailed version of this as part of my yearly planning, but you can start with a simple list of what you currently want. Here are a few examples:
...
Here’s the template I use in Logseq. You can copy this into your own graph:
...
This is a project I’m currently working on. I work on each active project every few days.

#### REVIEW

This means I’ve finished work on the project, and now am reflecting on the results.

I plan to add a more extensive project review step, but for now I just spend some time reflecting on what the outcome was, what could have been improved, what I learned, and what I’ll do better next time.
...
When I find a relevant resource, I save it in my daily notes and tag it with the project. If the reference is especially good, I move it from my daily notes into this section when going through linked references.
...
Examples include: lose weight, get better at programming, improve social life, etc.

### Desired output

What do I want the result of this project to be? What would I be doing afterward?

For example, for my weightlifting routine, I could say I want to squat 225 pounds. Or that I would feel healthier and fit into my old clothes.
...
I hope you enjoyed this guide to my Logseq project template.
...
See my logseq-tasks guide for more details on task management in Logseq.
...
[Older Notetaking with NLP and AI ](/notetaking-with-ai)[Newer Time Complexity Analysis](/time-complexity)

...
url: "https://briansunter.com/ai-powered-notetaking-with-the-gpt-3-logseq-plugin"
---
...
![Cover image for AI Powered Notetaking with the GPT-3 Logseq plugin](/_astro/image_1661149276371_0.DdmJCdfe_Z2fdDSU.webp)
...
[Logseq](https://logseq.com/) is an open-source bullet point notetaking app. I recently wrote an AI text generation plugin for it powered by the [OpenAI company](https://openai.com/)’s GPT-3 API. GPT-3 is a machine learning model that can generate human-like text from a given prompt. You type a command as you would to a human and run the Logseq `gpt3` command, and it then inserts a response underneath.
...
Visit the [OpenAI Examples Page](https://platform.openai.com/examples/) to understand what types of questions you can ask.
...
[Older Travels with Charley ](/travels-with-charley)[Newer Newsletter Issue 1](/newsletter/issue-1)

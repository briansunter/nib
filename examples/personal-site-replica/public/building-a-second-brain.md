...
url: "https://briansunter.com/building-a-second-brain"
---

DEC 29, 2022 · 17 MIN READ

# Building a Second Brain - Summary

My summary of Building a Second Brain by Tiago Forte, which is a guide to developing a productivity system to manage information and produce creative works.

![Cover image for Building a Second Brain - Summary](/_astro/basb_1672455079106_0.TSPs7pBV_1O5OKz.webp)
...
![code](/_astro/code_1672433388815_0.B_mN17up_2qbO89.webp)
...
- **Quotes**: memorable passages from podcasts, audiobooks, or videos
- **Bookmarks and favorites**: links to content you found on the internet or social media
- **Meeting notes**: notes or ideas from meetings or calls
...
- **Read-it-later apps** let you save interesting articles for later and highlight passages in them.
...
- **YouTube capture tools** let you save portions of YouTube videos as transcripts to your notes.
- **Voice memos** let you record your voice and transcribe it to text for your notes.
...
You need more time to consider the note before organizing it. Also, it increases the friction in capturing notes.
...
![progressive-summary](/_astro/progressive-summary_1672433105894_0.BpGIZr1D_OdSV5.webp)
...
![basb-project](/_astro/basb-project_1672457363980_0.CDscvco0_Z2kj6YS.webp)
...
### 4. Tag relevant notes to the project
...
[Older AI Learning Resources ](/ai-learning-resources)[Newer Books Read in 2022](/books-read-in-2022)

...
url: "https://briansunter.com/logseq-openai/popup"
---
...
A new popup interface for running custom GPT-3 commands in Logseq.

![Cover image for Logseq GPT-3 OpenAI Popup](/_astro/summarize_1674095683669_0.hZwRaP7H_xy7x.webp)
...
![Screenshot 2023-01-31 at 1.47.24 PM](/_astro/Screenshot_2023-01-31_at_1.47.24_PM_1675208862852_0.CCfC8H4v_Z1EOFuy.webp)

Screenshot 2023-01-31 at 1.47.24 PM
...
[](../../assets/videos/custom-prompt_1674094160276_0_1675213615966_0.mp4)
...
[](../../assets/videos/2023-01-18_16.22.13_1674095036177_0_1675214083513_0.mp4)

### Built-in commands

There are many built-in commands for common use cases

[](../../assets/videos/built-in-prompt-templates_1674096790451_0_1675214113992_0.mp4)
...
![summarize](/_astro/summarize_1674095683669_0.hZwRaP7H_xAdsT.webp)

summarize

#### Create outline of text

[](../../assets/videos/outline2_1674095716959_0_1675214186883_0.mp4)

#### Most important ideas in a text

[](../../assets/videos/important-ideas_1674095953444_0_1675214231308_0.mp4)

#### Common objections to an idea

[](../../assets/videos/common-objections_1674095797741_0_1675214273662_0.mp4)
...
![FmccSaQakAM6JF](/_astro/FmccSaQakAM6JF_1675294552245_0.BTvEucY6_ZlsnVs.webp)

FmccSaQakAM6JF

[](../../assets/videos/2023-01-13_14.20.49_1675294883999_0.mp4)
...
![Screenshot 2023-01-31 at 1.55.21 PM](/_astro/Screenshot_2023-01-31_at_1.55.21_PM_1675209353980_0.B8twgrbX_ZzRThX.webp)

Screenshot 2023-01-31 at 1.55.21 PM
...
[](../../assets/videos/user-prompt_1675204065803_0.mp4)
...
![Screenshot 2023-01-20 at 10.54.06 AM](/_astro/Screenshot_2023-01-20_at_10.54.06_AM_1675203364365_0.KDzQ_5Gp_ZCGsTb.webp)

Screenshot 2023-01-20 at 10.54.06 AM
...
[](../../assets/videos/video_1675205191234_0.mp4)
...
[](../../assets/videos/video_1675205447669_0.mp4)
...
I also want to add features that let you transform the input and output. For example, I could add the ability to remove markdown from the input text and split the output text into multiple blocks.
...
![Screenshot 2023-01-31 at 1.17.09 PM](/_astro/Screenshot_2023-01-31_at_1.17.09_PM_1675207870462_0.D_yNlELF_Z1HEhXt.webp)

Screenshot 2023-01-31 at 1.17.09 PM
...
[Older Binary Search Algorithm ](/binary-search)[Newer Newsletter Issue 10](/newsletter/issue-10)

...
assert.match(home, /data-nib-behavior="reading-goal"/, 'home should include the reading-goal behavior')
...
assert.doesNotMatch(post, /data-nib-behavior="reading-goal"/, 'post should not include the home behavior')

...
assert.match(home, /data-behavior="theme-toggle"/, 'shell should include the client behavior')
assert.match(home, /data-nib-enhancements/, 'client navigation should contribute its entry')
